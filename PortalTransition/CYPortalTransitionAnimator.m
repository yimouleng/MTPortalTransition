...
- (void)myAnimateTransition:(id <UIViewControllerContextTransitioning>)transitionContext;
{
...
//        leftImageView.frame = CGRectMake(0, 0, self, <#CGFloat height#>)
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext;
{
    ...
    NSDictionary *dict = @{@"1":leftImage,@"2":rightImage};
    [[NSNotificationCenter defaultCenter]postNotificationName:@"leftAndRight" object:nil userInfo:dict];
    //Add left and right doorside over fromView so that it will not be covered by fromView
    [fromView.superview addSubview:leftImageView];
    [fromView.superview addSubview:rightImageView];
